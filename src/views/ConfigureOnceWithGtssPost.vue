<template>
  <v-container class="blog-article">
    ...
    <section class="article-body">
      ...
      <p>
        Load a GTSS feed and the same finding reads: <em>Ygnacio Valley Road
        from the ESE, westbound</em>, called forty times, almost all on weekday
        ...
        is Ygnacio Valley Road lying 120° from the intersection. Nobody typed
        any of that in. The same chain is what turns a detector channel into a
